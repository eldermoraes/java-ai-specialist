 ...
 * Testes do client.
 *
 * <p>O teste de fumaça ({@link #assistenteFoiInjetado()}) prova a montagem: que o CDI
 ...
 * (CI incluído), sem Ollama e sem o order-hub-live-server.
 */
@QuarkusTest
class AssistentePedidosTest {
    ...
    /**
     * Teste de integração real: só roda com Ollama disponível e o order-hub-live-server no ar
     ...
     */
    @Test
    @Disabled("requer Ollama e o order-hub-live-server no ar")
